...
const AddUser = () => {
    ...
    const loadCiudades = async () => {
        const result = await axios.get('http://localhost:3001/ciudades', config);
                ...
                <form onSubmit={e => onSubmit(e)}>
                    ...
                    <div className="form-group">
                        <div className="form-control">
                            <input required className="form-check-input" value="F" type="radio" name="sexo" id="F"
                                   onChange={e => onInputChange(e)}/>
                        ...
                        <div className="form-control">
                            <input required className="form-check-input" value="M" type="radio" name="sexo" id="M"
                                   onChange={e => onInputChange(e)}/>
                    ...
                    <div className="form-group">
                        <select required aria-required="true" required name="ciudad_nacim_id"
                                className="form-control form-control-lg"
                                aria-label="Default select example" value={ciudad_nacim_id}
                                onChange={e => onInputChange(e)}>
                    ...
                    <div className="form-group">
                        <select required aria-required="true" id="grupo_id" name="grupo_id"
                                className="form-control form-control-lg"
